...
$adminStudentView = file_get_contents(__DIR__ . '/../admin/students/view.php');
...
assertConfirmationGubedcetFallback($adminStudentView !== false, 'admin student view is readable');
...
assertConfirmationGubedcetFallback(strpos($adminStudentView, 'GubedcetMeritListRepository') !== false, 'admin application preview resolves GUBEDCET data from the final merit list');
assertConfirmationGubedcetFallback(strpos($adminStudentView, "\$data['gubedcet_gender']") !== false, 'admin application preview populates GUBEDCET gender');
assertConfirmationGubedcetFallback(strpos($adminStudentView, "\$data['gubedcet_booklet_series']") !== false, 'admin application preview populates GUBEDCET booklet series');
